...
The grid module allows object tracking across 2D or 3D space.
"""
...
class Grid(object):
    ...
    def add(self, location, obj, name):
        """
        Add an object to a grid. If no Cell object is defined for this grid each cell may only hold a single object.
        """
        index = self.index(location)
